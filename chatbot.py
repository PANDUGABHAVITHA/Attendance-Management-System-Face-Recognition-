...
class ChatBot:
	def __init__(self,root):
		...
		img_chat=Image.open("college_images/chatIcon.jpg")
		...
		label_1=Label(btn_frame,text="Type Something",font=('times new roman',14,'bold'),fg='blue',bg='white')
	...
	def send(self):
		...
		if (self.entry.get()=='hello'):
			...
			self.text.insert(END,"\n\n"+"Bot: Bhavitha Panduga, a student of Computer Engineering from Osmania University")
